...
void startMenu()
{
    ...
    gotoxy(10,7);   cout<<" --------------------------";
    gotoxy(15,9);   cout<<"1. Start Game (Leader mode)";
    gotoxy(15,10);  cout<<"2. Play With Friend (1v1 mode)";
    gotoxy(15,11);  cout<<"3. Instructions";
    gotoxy(15,12);  cout<<"4. LeaderBoard";
    gotoxy(15,13);  cout<<"5. Quit";
...
void playForSolo()
{
	...
	while(1)
    {
        ...
        if (score %20==0&&score!=0&&speed>15)
        {
            speed=speed-8;
            if (score %40==0)
            {
...
void playSolo()
{
    ...
    string Player1="";
    string Player2="";
    int ScorePl1=0,ScorePl2=0;
    gotoxy(10,5);   cout<<" -------------------------- ";
    gotoxy(10,6);   cout<<" |       SoLo Mode        | ";
    gotoxy(10,7);   cout<<" --------------------------";
    gotoxy(12,9);   cout<<"Enter Player1's Name: ";
    getline(cin,Player1);
    playForSolo();
    ScorePl1=score;
    system("cls");
    ...
    gotoxy(10,6);   cout<<" |       SoLo Mode        | ";
    gotoxy(10,7);   cout<<" --------------------------";
    gotoxy(12,9);   cout<<"Enter Player2's Name: ";
    getline(cin,Player2);
    playForSolo();
    ScorePl2=score;
    system("cls");
    gotoxy(10,5);   cout<<" -------------------------- ";
    gotoxy(10,6);   cout<<" |         Result:        | ";
    gotoxy(10,7);   cout<<" --------------------------";
    gotoxy(12,9);
